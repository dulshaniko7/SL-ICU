            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-countryCustomers">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  let table = $('.datatable-countryCustomers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
