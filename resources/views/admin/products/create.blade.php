                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('product_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="product_code" id="product_code" value="{{ old('product_code', '') }}" required>
                            @if($errors->has('product_code'))
                                <span class="help-block" role="alert">{{ $errors->first('product_code') }}</span>
                            @endif
                        ...
                        <div class="form-group {{ $errors->has('product_price') ? 'has-error' : '' }}">
                            ...
                            @if($errors->has('product_price'))
                                <span class="help-block" role="alert">{{ $errors->first('product_price') }}</span>
                            @endif
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Product::STATUS_RADIO as $key => $label)
                                <div>
