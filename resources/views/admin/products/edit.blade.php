                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('product_code') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="product_code" id="product_code" value="{{ old('product_code', $product->product_code) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Product::STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $product->status) === (string) $key ? 'checked' : '' }}>
